...
//
_MAKE_MOTATE_PIN(kSocket1_EnablePinNumber, 'B', 5);            // Socket1_StepPinNumber
_MAKE_MOTATE_PIN(kSocket1_DirPinNumber, 'B', 3);              // Socket1_DirPinNumber
_MAKE_MOTATE_PIN(kSocket1_StepPinNumber, 'A', 10);          // Socket1_EnablePinNumber


_MAKE_MOTATE_PIN(kSocket2_EnablePinNumber, 'A', 8);             // Socket2_StepPinNumber
_MAKE_MOTATE_PIN(kSocket2_DirPinNumber, 'B', 10);              // Socket2_DirPinNumber
_MAKE_MOTATE_PIN(kSocket2_StepPinNumber, 'B', 4);           // Socket2_EnablePinNumber

_MAKE_MOTATE_PIN(kSocket3_EnablePinNumber, 'C', 0);             // Socket2_StepPinNumber
_MAKE_MOTATE_PIN(kSocket3_DirPinNumber, 'C', 1);              // Socket3_DirPinNumber
_MAKE_MOTATE_PIN(kSocket3_StepPinNumber, 'B', 0);           // Socket3_EnablePinNumber
