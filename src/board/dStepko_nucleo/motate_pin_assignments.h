...
pin_number kSerial_RTSPinNumber = -1; //8;  // added later
pin_number kSerial_CTSPinNumber = -1; //9;  // added later

pin_number kSerial0_RX  = -1; //0;
pin_number kSerial0_TX  = -1; //1;
pin_number kSerial0_RTS = -1; //8;  // added later
pin_number kSerial0_CTS = -1; //9;  // added later

pin_number kI2C_SDAPinNumber = -1; //2;
pin_number kI2C_SCLPinNumber = -1; //3;

pin_number kI2C0_SDAPinNumber = -1; //2;
pin_number kI2C0_SCLPinNumber = -1; //3;

pin_number kSPI_SCKPinNumber  = -1; //4;
pin_number kSPI_MISOPinNumber = -1; //5;
pin_number kSPI_MOSIPinNumber = -1; //6;

pin_number kSPI0_SCKPinNumber  = -1;// 4;
pin_number kSPI0_MISOPinNumber = -1; //5;
pin_number kSPI0_MOSIPinNumber = -1; //6;

pin_number kKinen_SyncPinNumber = -1; //7;
...
pin_number kSocket2_SPISlaveSelectPinNumber = -1;  // 20
...
pin_number kSocket2_VrefPinNumber           = -1;  // 28;

pin_number kSocket3_SPISlaveSelectPinNumber = -1;  // 30;
...
pin_number kSocket3_VrefPinNumber           = -1;  // 38;
...
pin_number kInput7_PinNumber  = 106; //106 Y2 ;
pin_number kInput8_PinNumber  = 107; //107 Touch plate;
...
pin_number kDebug1_PinNumber = 112;  // 112;
pin_number kDebug2_PinNumber = 113;  // 113;
pin_number kDebug3_PinNumber = 114;  // 116; // Note the out-of-order numbering & 115 missing
pin_number kDebug4_PinNumber = 115;  // 114;
// END DEBUG PINS

pin_number kLED_USBRXPinNumber     = 117;
pin_number kLED_USBTXPinNumber     = 118;
pin_number kSD_CardDetectPinNumber = -1; //119;
pin_number kSD_ChipSelectPinNumber = -1; //120;
pin_number kInterlock_InPinNumber  = -1; //121;
pin_number kOutputSAFE_PinNumber   = -1; //122;  // SAFE signal
pin_number kLEDPWM_PinNumber       = -1; //123;
...
pin_number kOutput1_PinNumber = -1; //130;  // DO_1:
pin_number kOutput2_PinNumber = -1; //131;  // DO_2:
pin_number kOutput3_PinNumber = -1; //132;  // DO_3: Fan1A_PWM
pin_number kOutput4_PinNumber = -1; //133;  // DO_4: Fan1B_PWM
pin_number kOutput5_PinNumber = -1; //134;  // DO_5: Fan2A_PWM
...
pin_number kOutput9_PinNumber  = -1;  //138;  // <unassigned, available out>
pin_number kOutput10_PinNumber = -1;  //139;  // DO_10: Fan2B_PWM

pin_number kOutput11_PinNumber = -1; //140;  //
pin_number kOutput12_PinNumber = -1;// 141;  // DO_12: Indicator_LED
pin_number kOutput13_PinNumber = -1;   // 142;
pin_number kOutput14_PinNumber = 143;  // 143; Extruder1_PWM
pin_number kOutput15_PinNumber = 144;   // 144; Extruder2_PWM
pin_number kOutput16_PinNumber = 145;   // 145; Heated Bed FET

pin_number kADC0_PinNumber  = 150; //150;  // Heated bed thermistor ADC
pin_number kADC1_PinNumber  = 151; //151;  // Extruder1_ADC
pin_number kADC2_PinNumber  = -1; //152;  // Extruder2_ADC
...
pin_number kADC13_PinNumber = -1; //163;  // Not physially pinned out
pin_number kADC14_PinNumber = -1; //164;  // Not physially pinned out
